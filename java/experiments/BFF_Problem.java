...
public class BFF_Problem {
	 ...
	 */
	public BFF_Problem() throws IOException, InterruptedException, ExecutionException {
	 ...
	 * @throws InterruptedException
	 */
	private void runMetrics(String dataset, BitSet iQ) throws InterruptedException {
		Callable<?> c1, c2, c3;
		ExecutorService executor = Executors.newCachedThreadPool();
